...
function Card({src,title="",description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.",tags=["tag1", "tag2", "tag3"]}) {
    return (
        <>
            <div className="max-w-sm rounded overflow-hidden shadow-lg bg-[#0000005d]">
                <img className="w-full" src={src} alt={title||"img"}/>
